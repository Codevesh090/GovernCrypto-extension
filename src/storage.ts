 ...
 */
export class WalletStorage implements StorageAPI {
  private static readonly WALLET_ADDRESS_KEY = 'walletAddress';
  private static readonly CONNECTION_TIMESTAMP_KEY = 'connectionTimestamp';
   ...
   */
  async getConnectionTimestamp(): Promise<number | null> {
    try {
